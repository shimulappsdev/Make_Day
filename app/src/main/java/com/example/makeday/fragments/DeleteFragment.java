...
import com.example.makeday.adapters.DeleteTaskAdapter;
import com.example.makeday.adapters.TaskAdapter;
import com.example.makeday.databinding.FragmentDeleteBinding;
...
public class DeleteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDeleteBinding.inflate(getLayoutInflater(), container, false);
        ...
        database.collection("tasks").document(currentUser).collection("myTask").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                adapter = new DeleteTaskAdapter(getActivity(), taskList);
