...
import com.example.makeday.databinding.FragmentEveryDayNoteBinding;
import com.example.makeday.databinding.FragmentNoteMainBinding;
import com.example.makeday.databinding.FragmentPersonalNoteBinding;
...
public class PersonalNoteFragment extends Fragment {
    ...
    FragmentPersonalNoteBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPersonalNoteBinding.inflate(getLayoutInflater(), container, false);
        ...
        database.collection("notes")
                ...
                .collection("myNote").whereEqualTo("note_category","Personal").addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        binding.personalNoteRecyclerView.setAdapter(adapter);
                        binding.progressBar.setVisibility(View.GONE);

                        SharedPreferences.Editor editor = preferences.edit();
                        editor.putInt("personalCount", noteList.size());
                        editor.apply();
