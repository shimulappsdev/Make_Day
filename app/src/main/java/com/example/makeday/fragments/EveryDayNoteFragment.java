...
public class EveryDayNoteFragment extends Fragment {

    FragmentEveryDayNoteBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentEveryDayNoteBinding.inflate(getLayoutInflater(), container, false);
        ...
        database.collection("notes")
                ...
                .collection("myNote").whereEqualTo("note_category","Every Day").addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        binding.everyDayNoteRecyclerView.setAdapter(adapter);
                        binding.progressBar.setVisibility(View.GONE);

                        SharedPreferences.Editor editor = preferences.edit();
                        editor.putInt("everyDayCount", noteList.size());
                        editor.apply();
