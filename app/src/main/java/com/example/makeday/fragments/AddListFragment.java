...
import com.example.makeday.databinding.FragmentAddListBinding;
...
public class AddListFragment extends Fragment {
    ...
    FragmentAddListBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAddListBinding.inflate(getLayoutInflater(), container, false);
        ...
        binding.completeListBtn.setOnClickListener(view -> {
            ...
            if (listTitle.equals("")){
                ...
                database.collection("lists")
                        ...
                        .collection("myLists")
                        .document(listId)
                        .set(listMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    dialog.dismiss();
