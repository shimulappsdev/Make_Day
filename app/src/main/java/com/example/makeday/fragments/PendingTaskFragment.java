...
public class PendingTaskFragment extends Fragment {
    ...
    FragmentPendingTaskBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPendingTaskBinding.inflate(getLayoutInflater(), container, false);
        ...
        database.collection("tasks")
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                binding.pendingTaskRecyclerView.setAdapter(adapter);
