...
import com.example.makeday.databinding.FragmentUpdateTaskBinding;
...
public class UpdateTaskFragment extends Fragment {
    ...
    String currentUser, categoryRadioString, priorityRadioSting;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentUpdateTaskBinding.inflate(getLayoutInflater(), container, false);
        ...
        database.collection("tasks")
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        if (data != null){
                            binding.addTitle.setText(data.get(0).getTask_title());
                            binding.startTimeInput.setText(data.get(0).getTask_startTime());
                            binding.endTimeInput.setText(data.get(0).getTask_endTime());
                            binding.dateInput.setText(data.get(0).getTask_date());
                            binding.addLocation.setText(data.get(0).getTask_location());
                            binding.addShortDes.setText(data.get(0).getTask_shortDes());
                            categoryRadioString = data.get(0).getTask_category();
                            priorityRadioSting = data.get(0).getTask_priority();
                        }
                    }
                });
        ...
        binding.updateTaskBtn.setOnClickListener(view -> {
            dialog.show();
        ...
        binding.backBtn.setOnClickListener(view -> {
            Intent updateIntent = new Intent(getActivity(), ContainerActivity.class);
            updateIntent.putExtra("showTask", "showTask");
            updateIntent.putExtra("taskId", taskId);
