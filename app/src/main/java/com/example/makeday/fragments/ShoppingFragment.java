...
import com.example.makeday.databinding.FragmentShoppingBinding;
...
public class ShoppingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        database.collection("tasks").document(currentUser).collection("myTask").whereEqualTo("task_category", "Shopping").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                binding.shoppingRecyclerView.setAdapter(adapter);

                SharedPreferences.Editor editor = categoryPreference.edit();
                editor.putInt("shoppingCount", taskList.size());
                editor.apply();
