...
import com.example.makeday.databinding.FragmentHealthBinding;
import com.example.makeday.databinding.FragmentWorkBinding;
...
public class WorkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWorkBinding.inflate(getLayoutInflater(), container, false);
        ...
        database.collection("tasks").document(currentUser).collection("myTask").whereEqualTo("task_category", "Work").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                binding.workRecyclerView.setAdapter(adapter);

                SharedPreferences.Editor editor = categoryPreference.edit();
                editor.putInt("workCount", taskList.size());
                editor.apply();
