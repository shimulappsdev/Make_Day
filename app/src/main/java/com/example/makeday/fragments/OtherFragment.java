...
import com.example.makeday.databinding.FragmentOtherBinding;
...
public class OtherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        database.collection("tasks").document(currentUser).collection("myTask").whereEqualTo("category_status","Other").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                binding.otherRecyclerView.setAdapter(adapter);

                SharedPreferences.Editor editor = categoryPreference.edit();
                editor.putInt("otherCount", taskList.size());
                editor.apply();
