...
import com.example.makeday.databinding.FragmentProfessionalNoteBinding;
...
public class ProfessionalNoteFragment extends Fragment {

    FragmentProfessionalNoteBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentProfessionalNoteBinding.inflate(getLayoutInflater(), container, false);
        ...
        database.collection("notes")
                ...
                .collection("myNote").whereEqualTo("note_category","Professional").addSnapshotListener(new EventListener<QuerySnapshot>() {
                    @Override
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        binding.professionalNoteRecyclerView.setAdapter(adapter);
                        binding.progressBar.setVisibility(View.GONE);

                        SharedPreferences.Editor editor = preferences.edit();
                        editor.putInt("professionalCount", noteList.size());
                        editor.apply();
