...
import com.example.makeday.databinding.FragmentPendingTaskBinding;
...
public class HealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHealthBinding.inflate(getLayoutInflater(), container, false);
        ...
        database.collection("tasks").document(currentUser).collection("myTask").whereEqualTo("task_category", "Health").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                editor.putInt("healthCount", taskList.size());
                editor.apply();
