...
import com.example.makeday.databinding.FragmentDoneTaskBinding;
...
public class DoneTaskFragment extends Fragment {
    ...
    FragmentDoneTaskBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDoneTaskBinding.inflate(getLayoutInflater(), container, false);
        ...
        database.collection("tasks").document(currentUser).collection("myTask").whereEqualTo("task_status", "Done").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                binding.doneTaskRecyclerView.setAdapter(adapter);
